...
class oan_Settings {
    ...
    public static function get_instance() {
		...
		$settings = 	apply_filters( 'oan_settings', 
									array(								
										'oan_general' => array(
											'title' 		=> __( 'General', 'overwrite-author-text-domain' ),
											'description' 	=> __( 'Select options to customise the overwrite of the author name during publishing a post/page.', 'overwrite-author-text-domain' ),
											'settings' 		=> array(		
																	array(
																		'name' 		=> 'oan_author_id',
																		'std' 		=> '0',
																		'label' 	=> __( 'Author Name to Enforce', 'overwrite-author-text-domain' ),
																		'desc'		=> __( 'If you wish to create a contents page add a new page and select it here so that the Help Note Contents are displayed.', 'overwrite-author-text-domain' ),
																		'type'      => 'field_wp_dropdown_users',
																		),	
																	array(
																		'name' 		=> 'oan_post_types',
																		'std' 		=> false,
																		'label' 	=> _x( 'Post Types', 'settings title for enabling the widgets for help notes.', 'overwrite-author-text-domain' ),
																		'cb_label'  => _x( 'Enable', 'enable the setting option.', 'overwrite-author-text-domain' ),
																		'desc'		=> __( "Only post types with 'author' support are listed.", 'overwrite-author-text-domain' ),
	...
	public function field_help_notes_taxonomy_options( array $args  ) {
		...
		public function field_wp_dropdown_users( array $args  ) {
			...
			wp_dropdown_users( array( 
									...
									'show_option_none' => _x( "- None -", 'text for no selection', 'overwrite-author-text-domain'), 
									'name' => $option['name'],
